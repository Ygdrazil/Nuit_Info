...
Route::get('/admin/sauveteur/nouveau', function () { return view('sauveteur.createSauveteur'); })->middleware(['auth'])->name('sauveteur.nouveau');
Route::post('/admin/sauveteur/nouveau', 'App\Http\Controllers\SauveteurController@create')->middleware(['auth'])->name('sauveteur.nouveau.post');
...
Route::get('/admin/sauvetage/nouveau', function () { return view('sauvetage.createSauvetage'); })->middleware(['auth'])->name('sauvetage.nouveau');
Route::post('/admin/sauvetage/nouveau', 'App\Http\Controllers\SauvetageController@create')->middleware(['auth'])->name('sauvetage.nouveau.post');
...
Route::get('/admin/bateau/nouveau', function () { return view('bateau.createBateau'); })->middleware(['auth'])->name('bateau.nouveau');
Route::post('/admin/bateau/nouveau', 'App\Http\Controllers\BateauController@create')->middleware(['auth'])->name('bateau.nouveau.post');